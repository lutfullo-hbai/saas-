...
class TestJWTService:
    ...
    def test_create_access_token_returns_string(self):
        ...
        token = create_access_token(uuid4(), "123456")
    ...
    def test_decode_access_token_valid(self):
        ...
        assert payload["telegram_id"] == telegram_id
    ...
    def test_create_refresh_token_returns_string(self):
        ...
        token = create_refresh_token(uuid4(), "123456")
        assert isinstance(token, str)
        assert len(token) > 0
    ...
    def test_decode_refresh_token_valid(self):
        ...
        user_id = uuid4()
        telegram_id = "123456"
        token = create_refresh_token(user_id, telegram_id)
    ...
    def test_refresh_token_has_unique_jti(self):
        ...
        token1 = create_refresh_token(uuid4(), "123456")
        token2 = create_refresh_token(uuid4(), "123456")
