...
class PrecisionEngineConfig(Base):
    ...
    tolerance_default: Mapped[int] = mapped_column(
        Float, nullable=False, default=10.0, comment="Standart tolerantlik (daqiqa)"
    )
    is_active: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=True, comment="Faol konfiguratsiya"
    )
    version: Mapped[int] = mapped_column(
        String(50), nullable=False, default="1", comment="Konfiguratsiya versiyasi"
    )
